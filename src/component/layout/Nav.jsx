            ...
            <div className="relative flex items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-30 sm:block m-auto">
                  <div className="flex gap-8">
                    <button>
                      <Link to={"/"} className="hover:text-green-400 font-bold">Home</Link>
                    </button>
                    {navigation.map((item, index) => (
                      <button
                        key={index}
                        className={classNames(
                          "text-black-300 hover:text-green-400",
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                {user ? (
                  ...
                  < Link to={'/signin'} className="hover:text-green-400 flex items-center ">
                    <svg
